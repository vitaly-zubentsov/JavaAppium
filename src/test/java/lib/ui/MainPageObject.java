...
public class MainPageObject {
    ...
    public void swipeUpToFindElement(String locator, String error_messages, int max_swipes) {
    ...
    public void swipeUpTillElementAppear(String locator, String error_messages, int max_swipes) {
        ...
        while (!this.isElementLocatedOnTheScreen(locator)) {
            ...
            if (already_swiped > max_swipes) {
                Assert.assertTrue(error_messages, this.isElementLocatedOnTheScreen(locator));
            }
    ...
    public boolean isElementLocatedOnTheScreen(String locator) {
        ...
        int element_location_by_y = this.
                waitForElementPresent(locator, "Cannot find element by locator" + locator, 1).
                getLocation().
                getY();
        if (Platform.getInstance().isMW()) {
            JavascriptExecutor JSExecutore = (JavascriptExecutor) driver;
            Object js_result = JSExecutore.executeScript("return window.pageYOffset");
    ...
    public List waitForElementsIsPresentAndGetListOfThem(String locator, String error_message, long timeoutInSeconds) {
